...
requirements = python3,kivy==2.1.0,kivymd==0.104.2,pillow==8.3.1,gTTS,pyttsx3,wikipedia,pywhatkit,plyer,requests
...
# (list) Permissions
android.permissions = INTERNET,ACCESS_NETWORK_STATE,READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE,RECORD_AUDIO
